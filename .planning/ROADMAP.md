...
**Plans**: 1/4 plans executed (4 waves, secuenciales — todos los planes comparten `ALLOWLIST.md` y `OVERRIDES.md`, y los planes 1, 3 y 4 comparten `layout/theme.liquid` o `locales/*`)
...
| 3. Layout shell + seams de Etapa 2 | 1/4 | In Progress|  |
